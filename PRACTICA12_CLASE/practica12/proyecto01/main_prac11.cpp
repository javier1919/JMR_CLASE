...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rotInc=(KeyFrame[playIndex+1].rotInc-KeyFrame[playIndex].BrIzq)/ i_max_steps;
	KeyFrame[FrameIndex].rotInc2=(KeyFrame[playIndex+1].BrIzq-KeyFrame[playIndex].BrIzq)/ i_max_steps;
	KeyFrame[FrameIndex].rotInc3=(KeyFrame[playIndex+1].BrDer-KeyFrame[playIndex].BrDer)/ i_max_steps;
	KeyFrame[FrameIndex].rotInc4=(KeyFrame[playIndex+1].PieDer-KeyFrame[playIndex].PieDer)/ i_max_steps;
	KeyFrame[FrameIndex].rotInc5=(KeyFrame[playIndex+1].PieIzq-KeyFrame[playIndex].PieIzq)/ i_max_steps;
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			PieIzq +=KeyFrame[playIndex].PieIzq;
			PieDer +=KeyFrame[playIndex].PieDer;
