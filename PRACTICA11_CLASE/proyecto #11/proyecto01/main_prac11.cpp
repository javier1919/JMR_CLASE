...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rotInc=(KeyFrame[playIndex+1].rotInc-KeyFrame[playIndex].rotRodIzq)/ i_max_steps;
	KeyFrame[FrameIndex].BrIzq=(KeyFrame[playIndex+1].BrIzq-KeyFrame[playIndex].rotInc2)/ i_max_steps;
	KeyFrame[FrameIndex].BrDer=(KeyFrame[playIndex+1].BrDer-KeyFrame[playIndex].rotInc3)/ i_max_steps;
	KeyFrame[FrameIndex].PieDer=(KeyFrame[playIndex+1].PieDer-KeyFrame[playIndex].rotInc4)/ i_max_steps;
	KeyFrame[FrameIndex].PieIzq=(KeyFrame[playIndex+1].PieIzq-KeyFrame[playIndex].rotInc5)/ i_max_steps;
	KeyFrame[FrameIndex].KBZ = (KeyFrame[playIndex + 1].KBZ - KeyFrame[playIndex].rotInc6) / i_max_steps;
	KeyFrame[FrameIndex].cuello = (KeyFrame[playIndex + 1].cuello - KeyFrame[playIndex].rotInc7) / i_max_steps;
	KeyFrame[FrameIndex].cintura = (KeyFrame[playIndex + 1].cintura - KeyFrame[playIndex].rotInc8) / i_max_steps;

	KeyFrame[FrameIndex].rotInc2 = (KeyFrame[playIndex + 1].rotInc2 - KeyFrame[playIndex].rotInc2) / i_max_steps;
	KeyFrame[FrameIndex].rotInc3 = (KeyFrame[playIndex + 1].rotInc3 - KeyFrame[playIndex].rotInc3) / i_max_steps;
	KeyFrame[FrameIndex].rotInc4 = (KeyFrame[playIndex + 1].rotInc4 - KeyFrame[playIndex].rotInc4) / i_max_steps;
	KeyFrame[FrameIndex].rotInc5 = (KeyFrame[playIndex + 1].rotInc5 - KeyFrame[playIndex].rotInc5) / i_max_steps;
	KeyFrame[FrameIndex].rotInc6 = (KeyFrame[playIndex + 1].rotInc6 - KeyFrame[playIndex].rotInc6) / i_max_steps;
	KeyFrame[FrameIndex].rotInc7 = (KeyFrame[playIndex + 1].rotInc7 - KeyFrame[playIndex].rotInc7) / i_max_steps;
	KeyFrame[FrameIndex].rotInc8 = (KeyFrame[playIndex + 1].rotInc8 - KeyFrame[playIndex].rotInc8) / i_max_steps;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].BrIzq = (KeyFrame[playIndex + 1].BrIzq - KeyFrame[playIndex].BrIzq) / i_max_steps;
	KeyFrame[playIndex].BrDer = (KeyFrame[playIndex + 1].BrDer - KeyFrame[playIndex].BrDer) / i_max_steps;
	KeyFrame[playIndex].PieIzq = (KeyFrame[playIndex + 1].PieIzq - KeyFrame[playIndex].PieIzq) / i_max_steps;
	KeyFrame[playIndex].PieDer = (KeyFrame[playIndex + 1].PieDer - KeyFrame[playIndex].PieDer) / i_max_steps;
	KeyFrame[playIndex].KBZ = (KeyFrame[playIndex + 1].KBZ - KeyFrame[playIndex].KBZ) / i_max_steps;
	KeyFrame[playIndex].cuello = (KeyFrame[playIndex + 1].cuello - KeyFrame[playIndex].cuello) / i_max_steps;
	KeyFrame[playIndex].cintura = (KeyFrame[playIndex + 1].cintura - KeyFrame[playIndex].cintura) / i_max_steps;
